...
import org.openmrs.module.reportingcompatibility.ReportingCompatibilityUtil;
...
public class PatientSearchCohortDefinitionProvider implements CohortDefinitionProvider {
	...
	public List<CohortDefinitionItemHolder> getAllCohortDefinitions() {
		...
		List<AbstractReportObject> patientSearches = ros.getReportObjectsByType(
	...
	public CohortDefinition getCohortDefinition(Integer id) {
		ReportObjectService ros = (ReportObjectService) Context.getService(ReportObjectService.class);
		PatientSearchReportObject psro = (PatientSearchReportObject) ros.getReportObject(id);
