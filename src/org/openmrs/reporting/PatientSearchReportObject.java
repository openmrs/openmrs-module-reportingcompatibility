...
public class PatientSearchReportObject extends AbstractReportObject {
	...
	public PatientSearchReportObject() {
		super.setType(ReportingCompatibilityConstants.REPORT_OBJECT_TYPE_PATIENTSEARCH);
		super.setSubType(ReportingCompatibilityConstants.REPORT_OBJECT_TYPE_PATIENTSEARCH);
	}
