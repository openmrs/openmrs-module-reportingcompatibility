...
/**
 * Contains all utility methods required to support compatibility of reporting in 
...
public class ReportingCompatibilityUtil {
	...
	public static PatientFilter toPatientFilter(PatientSearch search, CohortSearchHistory history,
		...
		if (search.isSavedSearchReference()) {
			PatientSearch ps = ((PatientSearchReportObject) ros.getReportObject(
			...
			return ros.getPatientFilterById(search.getSavedFilterId());
