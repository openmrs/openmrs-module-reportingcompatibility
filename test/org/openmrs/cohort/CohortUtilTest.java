...
public class CohortUtilTest extends BaseModuleContextSensitiveTest {
	...
	public void parse_shouldParseSpecificationWithAndInIt() throws Exception {
		...
		ReportObjectService ros = (ReportObjectService) Context.getService(ReportObjectService.class);
		{
			...
			ros.saveReportObject(new PatientSearchReportObject("Male", ps));
		}
		{
			...
			ros.saveReportObject(new PatientSearchReportObject("EnrolledOnDate", ps));
		}
		
		// TODO this is the actual test.  Move the above logic into a dbunit xml file or use the standard xml run by BaseModuleContextSensitiveTest
