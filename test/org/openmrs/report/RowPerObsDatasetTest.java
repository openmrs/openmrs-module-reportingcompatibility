...
public class RowPerObsDatasetTest extends BaseModuleContextSensitiveTest {
	...
	public void shouldSerialize() throws Exception {
		...
		DataSetService service = (DataSetService)Context.getService(DataSetService.class);
		...
		Cohort kidsCohort = cs.evaluate(kids, evalContext);
		...
		ReportData data = rptSvc.evaluate(rs, kidsCohort, evalContext);
